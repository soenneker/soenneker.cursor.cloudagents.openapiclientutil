...
Instead, report it privately using this repository�s [GitHub private vulnerability reporting tool](https://github.com/soenneker/soenneker.cursor.cloudagents.openapiclientutil/security/advisories/new).
